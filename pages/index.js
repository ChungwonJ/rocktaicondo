  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:title" content="락타이콘도 - 태국여행 및 콘도 예약 | 락타이 콘도 - 태국 콘도 예약 시스템" />
        <meta property="og:description" content="태국여행을 계획 중이라면, 방콕, 파타야 등 다양한 지역의 콘도를 쉽게 예약하세요. 락타이콘도는 최고의 콘도 정보를 제공합니다." />
